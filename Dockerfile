...
RUN apt-get install -y curl wget git subversion gzip sudo apt-utils
# adding user track
...
RUN cd /home/track/track/track/scripts/rush/; python3 /home/track/track/track/scripts/rush/dump.py
RUN cd /home/track/track/track/scripts/; python3 /home/track/track/track/scripts/setup.py
RUN su track
# Start the bot
